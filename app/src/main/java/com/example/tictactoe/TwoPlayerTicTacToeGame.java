...
public class TwoPlayerTicTacToeGame implements Serializable, TicTacToeGame {
    private CellValue[] board;
    private int level;
    private GameState gameState;

    public TwoPlayerTicTacToeGame(){
    ...
    public boolean equals(Object o) {
        ...
        TwoPlayerTicTacToeGame other = (TwoPlayerTicTacToeGame)o;
